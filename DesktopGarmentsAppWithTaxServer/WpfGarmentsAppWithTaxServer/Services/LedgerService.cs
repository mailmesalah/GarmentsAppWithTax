...
namespace WpfServerApp.Services
{
    public class LedgerService : ILedger
    {
        ...
        public ObservableCollection<CLedger> ReadAllLedgersWithGroupAsTree()
        {
            ...
            try
            {
                using (var dataB1 = new Database9003Entities())
                {
                    using (var dataB2 = new Database9003Entities())
                    {
                        using (var dataB3 = new Database9003Entities())
                        {
                            using (var dataB4 = new Database9003Entities())
                            {
