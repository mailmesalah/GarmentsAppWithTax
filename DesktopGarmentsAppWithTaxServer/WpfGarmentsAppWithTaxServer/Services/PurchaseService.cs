    ...
    {        
        ...
        public bool CreateBill(CPurchase oPurchase, string billType)
        {
            ...
            lock (Synchronizer.@lock)
            {
                ...
                using (var dataB = new Database9003Entities())
                {
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < oPurchase.Details.Count; i++)
                        {
                            ...
                            pt.brand_code = oPurchase.Details.ElementAt(i).BrandCode == "" ? pps.CreateProperty(ls.ReadGroupCodeOf(oPurchase.Details.ElementAt(i).ProductCode), oPurchase.Details.ElementAt(i).Brand, "1").PropertyCode : oPurchase.Details.ElementAt(i).BrandCode;
                            pt.size_code = oPurchase.Details.ElementAt(i).SizeCode == "" ? pps.CreateProperty(ls.ReadGroupCodeOf(oPurchase.Details.ElementAt(i).ProductCode), oPurchase.Details.ElementAt(i).Size, "2").PropertyCode : oPurchase.Details.ElementAt(i).SizeCode;
                            pt.colour_code = oPurchase.Details.ElementAt(i).ColourCode == "" ? pps.CreateProperty(ls.ReadGroupCodeOf(oPurchase.Details.ElementAt(i).ProductCode), oPurchase.Details.ElementAt(i).Colour, "3").PropertyCode : oPurchase.Details.ElementAt(i).ColourCode;
                            pt.brand = oPurchase.Details.ElementAt(i).Brand;
                            pt.size = oPurchase.Details.ElementAt(i).Size;
                            pt.colour = oPurchase.Details.ElementAt(i).Colour;
                            //get a barcode here
        ...
        //Reports
        public List<CPurchaseReportDetailed> FindPurchaseDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string brandCode, string brand, string colourCode, string colour, string sizeCode, string size, string narration, string financialCode)
        {
        ...
        public List<CPurchaseReportSummary> FindPurchaseSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string brandCode, string brand, string colourCode, string colour, string sizeCode, string size, string narration, string financialCode)
        {
