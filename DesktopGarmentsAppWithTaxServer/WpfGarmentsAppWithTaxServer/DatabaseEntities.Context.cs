...
namespace WpfServerApp
{
    ...
    public partial class Database9003Entities : DbContext
    {
        public Database9003Entities()
            : base("name=Database9003Entities")
        {
        }
        ...
        public virtual DbSet<product_property_code> product_property_code { get; set; }
